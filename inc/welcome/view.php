...
<div class="wrap about-wrap">
	...
	<div class="about-text">
		<?php _e( 'Alpha is a clean and minimalistic magazine/blog theme for those who like to create content each day. It is user-friendly, responsive, retina ready and performs well. It currently supports Contact Form 7 and various Jetpack features.', 'pine-alpha' ); ?>
	</div>
