...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input type="search" id="<?php echo $unique_id; ?>sidebar" class="search-form__input" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'pine-alpa' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
